...
| Command-ready remembered detached-proof `NIP-03` verification plus bounded remembered-proof runtime, grouped target policy, refresh-cadence, refresh-batch, archive-backed refresh readiness, turn-policy, and refresh planning over the explicit HTTP, proof-store, verification-store, and event-archive seams | `noztr_sdk.client.proof.nip03.Nip03VerifyClient` | [nip03_verify_client.zig](../../examples/nip03_verify_client.zig) |
| Command-ready remembered `NIP-05` lookup and verify job composition plus bounded remembered-resolution freshness and refresh planning over the explicit HTTP seam | `noztr_sdk.client.identity.nip05.Nip05VerifyClient` | [nip05_verify_client.zig](../../examples/nip05_verify_client.zig) |
| Command-ready remembered `NIP-39` profile verification plus remembered-identity latest freshness, refresh-cadence, refresh-batch, and stored watched-target policy, refresh-cadence, refresh-batch, turn, and orchestration planning over the explicit HTTP, cache, verification-store, and profile-store seams | `noztr_sdk.client.identity.nip39.Nip39VerifyClient` | [nip39_verify_client.zig](../../examples/nip39_verify_client.zig) |
...
| App-facing DM capability composition for kind-`10050` mailbox relay-list publish/query/store/selection plus mailbox-versus-legacy protocol inspection and explicit reply-protocol choice above the shared publish/query/archive seams | `noztr_sdk.client.dm.capability.DmCapabilityClient` | [dm_capability_client.zig](../../examples/dm_capability_client.zig) |
| App-facing mixed DM intake plus bounded outbound mailbox-versus-legacy authoring that normalizes mailbox and legacy observations, keeps reply-route selection explicit, and keeps sender-protocol memory plus replay/live dedup caller-owned above the existing DM workflow floors plus the DM capability route | `noztr_sdk.client.dm.mixed.MixedDmClient` | [mixed_dm_client.zig](../../examples/mixed_dm_client.zig) |
...
| Command-ready auth-aware legacy `NIP-04` publish posture over the legacy DM workflow floor plus shared relay runtime | `noztr_sdk.client.dm.legacy.publish_job.LegacyDmPublishJobClient` | [legacy_dm_publish_job_client.zig](../../examples/legacy_dm_publish_job_client.zig) |
| Bounded checkpoint-backed legacy `NIP-04` replay over replay turns plus direct kind-`4` plaintext intake from parsed transcript events | `noztr_sdk.client.dm.legacy.replay_turn.LegacyDmReplayTurnClient` | [legacy_dm_replay_turn_client.zig](../../examples/legacy_dm_replay_turn_client.zig) |
| Command-ready auth-aware legacy `NIP-04` replay posture over bounded replay turns plus explicit checkpoint saves | `noztr_sdk.client.dm.legacy.replay_job.LegacyDmReplayJobClient` | [legacy_dm_sync_runtime_client.zig](../../examples/legacy_dm_sync_runtime_client.zig) |
| Bounded live legacy `NIP-04` subscription composition over shared subscription turns plus direct kind-`4` plaintext intake from parsed transcript events | `noztr_sdk.client.dm.legacy.subscription_turn.LegacyDmSubscriptionTurnClient` | [legacy_dm_subscription_turn_client.zig](../../examples/legacy_dm_subscription_turn_client.zig) |
| Command-ready auth-aware legacy `NIP-04` live subscription posture over bounded subscription turns | `noztr_sdk.client.dm.legacy.subscription_job.LegacyDmSubscriptionJobClient` | [legacy_dm_sync_runtime_client.zig](../../examples/legacy_dm_sync_runtime_client.zig) |
| Bounded legacy `NIP-04` sync-runtime planning plus explicit longer-lived DM policy, cadence/backoff, and broader DM orchestration helpers with durable resume export/restore over auth, replay catch-up, explicit reconnect, live subscribe, and live receive posture | `noztr_sdk.client.dm.legacy.sync_runtime.Client` | [legacy_dm_sync_runtime_client.zig](../../examples/legacy_dm_sync_runtime_client.zig) |
...
| Command-ready mailbox auth, publish, and receive posture over mailbox sync turns plus local auth-event signing | `noztr_sdk.client.dm.mailbox.job.MailboxJobClient` | [mailbox_job_client.zig](../../examples/mailbox_job_client.zig) |
| Command-ready signer-backed mailbox direct-message authoring above the bounded signer client plus explicit mailbox delivery planning over verified relay lists | `noztr_sdk.client.dm.mailbox.signer_job.MailboxSignerJobClient` | [mailbox_signer_job_client.zig](../../examples/mailbox_signer_job_client.zig) |
| Bounded live mailbox subscription composition over shared subscription turns plus direct mailbox envelope intake from parsed transcript events | `noztr_sdk.client.dm.mailbox.subscription_turn.MailboxSubscriptionTurnClient` | [mailbox_subscription_turn_client.zig](../../examples/mailbox_subscription_turn_client.zig) |
| Command-ready auth-aware mailbox subscription posture over bounded mailbox subscription turns | `noztr_sdk.client.dm.mailbox.subscription_job.MailboxSubscriptionJobClient` | [mailbox_subscription_job_client.zig](../../examples/mailbox_subscription_job_client.zig) |
| Bounded mailbox sync-runtime planning plus explicit longer-lived DM policy, cadence/backoff, and broader DM orchestration helpers with durable resume export/restore over auth, replay catch-up, explicit reconnect, live subscribe, and live receive posture | `noztr_sdk.client.dm.mailbox.sync_runtime.Client` | [mailbox_sync_runtime_client.zig](../../examples/mailbox_sync_runtime_client.zig) |
| Bounded checkpoint-backed mailbox replay over replay turns plus direct mailbox envelope intake from parsed transcript events | `noztr_sdk.client.dm.mailbox.replay_turn.MailboxReplayTurnClient` | [mailbox_replay_turn_client.zig](../../examples/mailbox_replay_turn_client.zig) |
| Command-ready auth-aware mailbox replay posture over bounded mailbox replay turns plus explicit checkpoint saves | `noztr_sdk.client.dm.mailbox.replay_job.MailboxReplayJobClient` | [mailbox_replay_job_client.zig](../../examples/mailbox_replay_job_client.zig) |
| Detached OpenTimestamps proof verification, remembered proof reuse, archive-backed refresh readiness, and grouped remembered-proof policy | `noztr_sdk.workflows.proof.nip03.OpenTimestampsVerifier` | [nip03_verification.zig](../../examples/nip03_verification.zig) |
| Identity verification, remembered profile discovery, remembered-identity latest freshness, refresh-cadence, refresh-batch, explicit watched-target storage, watched-target policy, refresh-cadence, refresh-batch, turn, and orchestration planning | `noztr_sdk.workflows.identity.verify.IdentityVerifier` | [nip39_verification.zig](../../examples/nip39_verification.zig) |
| `NIP-05` address resolution, remembered successful resolution storage, and bounded address-target freshness and refresh planning over the public HTTP seam | `noztr_sdk.workflows.identity.nip05.Nip05Resolver` | [nip05_resolution.zig](../../examples/nip05_resolution.zig) |
