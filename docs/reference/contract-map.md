...
| Command-ready `NIP-05` lookup and verify job composition over the explicit HTTP seam | `noztr_sdk.client`, `Nip05VerifyClient`, `Nip05VerifyClientStorage`, `Nip05LookupJob`, `Nip05VerifyJob`, `Nip05LookupJobResult`, `Nip05VerifyJobResult`, `noztr_sdk.transport.HttpClient` | `noztr_sdk.client.Nip05VerifyClient` | [nip05_verify_client_recipe.zig](../../examples/nip05_verify_client_recipe.zig) |
| Command-ready remembered `NIP-39` profile verification over the explicit HTTP, cache, and profile-store seams | `noztr_sdk.client`, `Nip39VerifyClient`, `Nip39VerifyClientStorage`, `Nip39VerifyJob`, `Nip39VerifySummary`, `Nip39VerifyJobResult`, `MemoryIdentityVerificationCache`, `MemoryIdentityProfileStore`, `noztr_sdk.transport.HttpClient` | `noztr_sdk.client.Nip39VerifyClient` | [nip39_verify_client_recipe.zig](../../examples/nip39_verify_client_recipe.zig) |
