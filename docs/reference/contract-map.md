...
| Social reply composition for kind-`1` notes plus `NIP-22` comment publish and explicit stored comment-page inspection above the local operator, publish, relay-query, and event-archive floors | `noztr_sdk.client.social.comment_reply.Client` | [social_comment_reply_client.zig](../../examples/social_comment_reply_client.zig) |
| Social highlight composition plus explicit stored highlight-page inspection above the local operator, publish, relay-query, and event-archive floors | `noztr_sdk.client.social.highlight.Client` | [social_highlight_client.zig](../../examples/social_highlight_client.zig) |
...
| Command-ready remembered detached-proof `NIP-03` verification plus bounded runtime and refresh planning over explicit HTTP, proof-store, verification-store, and event-archive seams; use `client.proof.nip03.Planning.*` for the planning family | `noztr_sdk.client.proof.nip03.Nip03VerifyClient` | [nip03_verify_client.zig](../../examples/nip03_verify_client.zig) |
| Command-ready remembered `NIP-05` lookup and verify composition plus bounded resolution freshness and refresh planning over the explicit HTTP seam; use `client.identity.nip05.Planning.*` for the planning family | `noztr_sdk.client.identity.nip05.Nip05VerifyClient` | [nip05_verify_client.zig](../../examples/nip05_verify_client.zig) |
...
| Explicit `NIP-57` zap request publish plus pay-endpoint fetch, callback invoice fetch, and request-bound receipt validation over the shared publish and HTTP seams | `noztr_sdk.workflows.zaps.ZapFlow` | [zap_flow.zig](../../examples/zap_flow.zig) |
...
| Shared signer capability vocabulary plus local remote and browser adapter composition above existing local-operator `NIP-46` and thin browser signer surfaces | `noztr_sdk.client.signer.capability.Profile` | [signer_capability.zig](../../examples/signer_capability.zig) |
...
| Command-ready signer connect job composition above the bounded signer client plus explicit relay auth acceptance | `noztr_sdk.client.signer.connect_job.Client` | [signer_connect_job_client.zig](../../examples/signer_connect_job_client.zig) |
| First signer-tooling client composition above the remote-signer workflow plus shared relay runtime, durable resume, and explicit signer-session policy/cadence | `noztr_sdk.client.signer.session.Client` | [signer_client.zig](../../examples/signer_client.zig) |
| Command-ready signer `nip44_encrypt` job composition above the bounded signer client plus explicit relay auth acceptance | `noztr_sdk.client.signer.nip44_encrypt_job.Client` | [signer_nip44_encrypt_job_client.zig](../../examples/signer_nip44_encrypt_job_client.zig) |
| Command-ready signer public-key job composition above the bounded signer client plus explicit relay auth acceptance | `noztr_sdk.client.signer.pubkey_job.Client` | [signer_pubkey_job_client.zig](../../examples/signer_pubkey_job_client.zig) |
...
| Command-ready signer-backed mailbox direct-message authoring above the bounded signer client plus explicit mailbox delivery planning | `noztr_sdk.client.dm.mailbox.signer_job.Client` | [mailbox_signer_job_client.zig](../../examples/mailbox_signer_job_client.zig) |
...
| Detached OpenTimestamps proof verification plus remembered-proof reuse and bounded refresh planning; use `workflows.proof.nip03.Planning.*` for the planning family | `noztr_sdk.workflows.proof.nip03.OpenTimestampsVerifier` | [nip03_verification.zig](../../examples/nip03_verification.zig) |
...
| `NIP-05` address resolution plus remembered successful resolutions and bounded freshness/refresh planning over the public HTTP seam; use `workflows.identity.nip05.Planning.*` for the planning family | `noztr_sdk.workflows.identity.nip05.Nip05Resolver` | [nip05_resolution.zig](../../examples/nip05_resolution.zig) |
