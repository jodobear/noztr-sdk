...
| Minimal CLI-facing client composition over shared store plus relay runtime | `noztr_sdk.client`, `CliArchiveClient`, `CliArchiveClientStorage`, `noztr_sdk.store`, `noztr_sdk.runtime` | `noztr_sdk.client.CliArchiveClient` | [cli_archive_client_recipe.zig](/workspace/projects/nzdk/examples/cli_archive_client_recipe.zig) |
