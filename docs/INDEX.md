...
- `client.dm.*`
  - DM capability, app-facing mixed mailbox-plus-legacy composition, signer-backed mailbox
    authoring, and mailbox plus legacy-DM runtime, replay, subscription, and orchestration
    composition
- `client.identity.*`
