...
test "root module exposes workflows store runtime plus the explicit http seam" {
    ...
    try std.testing.expect(@TypeOf(client.LocalStateClientError) == type);
    try std.testing.expect(@TypeOf(client.LocalStateClientConfig) == type);
    try std.testing.expect(@TypeOf(client.LocalStateClientStorage) == type);
    try std.testing.expect(@TypeOf(client.LocalStateRestoreResult) == type);
    try std.testing.expect(@TypeOf(client.LocalStateClient) == type);
    ...
    try std.testing.expect(@TypeOf(client.RelaySessionClientError) == type);
    try std.testing.expect(@TypeOf(client.RelaySessionClientConfig) == type);
    try std.testing.expect(@TypeOf(client.RelaySessionClientStorage) == type);
    try std.testing.expect(@TypeOf(client.RelaySessionCloseRequest) == type);
    try std.testing.expect(@TypeOf(client.RelaySessionClient) == type);
...
test "phase4e exposes the legacy dm replay live runtime floors" {
    ...
    try std.testing.expect(@TypeOf(client.LegacyDmRuntimeCadenceRequest) == type);
    try std.testing.expect(@TypeOf(client.LegacyDmRuntimeCadenceStorage) == type);
    try std.testing.expect(@TypeOf(client.LegacyDmRuntimeCadenceWaitReason) == type);
    try std.testing.expect(@TypeOf(client.LegacyDmRuntimeCadenceWait) == type);
    try std.testing.expect(@TypeOf(client.LegacyDmRuntimeCadenceStep) == type);
    try std.testing.expect(@TypeOf(client.LegacyDmRuntimeCadencePlan) == type);
    ...
    try std.testing.expect(@TypeOf(client.GroupFleetClientCheckpointStorage) == type);
    try std.testing.expect(@TypeOf(client.GroupFleetClientCheckpointRequest) == type);
...
test "phase6 exposes the identity verifier workflow surface" {
    ...
    try std.testing.expect(@TypeOf(workflows.IdentityWatchedTargetStoreError) == type);
    try std.testing.expect(@TypeOf(workflows.IdentityWatchedTargetRecord) == type);
    try std.testing.expect(@TypeOf(workflows.IdentityWatchedTargetResultPage) == type);
    ...
    try std.testing.expect(@TypeOf(workflows.IdentityRememberedIdentityRecord) == type);
    try std.testing.expect(@TypeOf(workflows.IdentityRememberedIdentityResultPage) == type);
    try std.testing.expect(@TypeOf(workflows.IdentityRememberedIdentityPlanningError) == type);
    try std.testing.expect(@TypeOf(workflows.IdentityRememberedIdentityLatestFreshnessStorage) == type);
    try std.testing.expect(@TypeOf(workflows.IdentityRememberedIdentityLatestFreshnessRequest) == type);
    try std.testing.expect(@TypeOf(workflows.IdentityRememberedIdentityLatestFreshnessPlan) == type);
    try std.testing.expect(@TypeOf(workflows.IdentityRememberedIdentityRefreshCadenceStorage) == type);
    try std.testing.expect(@TypeOf(workflows.IdentityRememberedIdentityRefreshCadenceRequest) == type);
    try std.testing.expect(@TypeOf(workflows.IdentityRememberedIdentityRefreshCadencePlan) == type);
    try std.testing.expect(@TypeOf(workflows.IdentityRememberedIdentityRefreshBatchStorage) == type);
    try std.testing.expect(@TypeOf(workflows.IdentityRememberedIdentityRefreshBatchRequest) == type);
    try std.testing.expect(@TypeOf(workflows.IdentityRememberedIdentityRefreshBatchPlan) == type);
    ...
    try std.testing.expect(@TypeOf(workflows.IdentityStoredWatchedTargetOrchestrationError) == type);
    try std.testing.expect(@TypeOf(workflows.IdentityStoredWatchedTargetOrchestrationStorage) == type);
    try std.testing.expect(@TypeOf(workflows.IdentityStoredWatchedTargetOrchestrationRequest) == type);
    try std.testing.expect(@TypeOf(workflows.IdentityStoredWatchedTargetOrchestrationPlan) == type);
    ...
    try std.testing.expect(@TypeOf(workflows.IdentityStoredWatchedTargetTurnPolicyPlan) == type);
    ...
    try std.testing.expect(@TypeOf(workflows.IdentityWatchedTargetStore) == type);
    try std.testing.expect(@TypeOf(workflows.MemoryIdentityWatchedTargetStore) == type);
...
test "phase7 exposes the opentimestamps verifier workflow surface" {
    ...
    try std.testing.expect(@TypeOf(workflows.OpenTimestampsStoredVerificationTargetPolicyRequest) == type);
    try std.testing.expect(@TypeOf(workflows.OpenTimestampsStoredVerificationTargetPolicyPlan) == type);
    try std.testing.expect(@TypeOf(workflows.OpenTimestampsStoredVerificationTargetRefreshCadenceAction) == type);
    try std.testing.expect(@TypeOf(workflows.OpenTimestampsStoredVerificationTargetRefreshCadenceEntry) == type);
    try std.testing.expect(@TypeOf(workflows.OpenTimestampsStoredVerificationTargetRefreshCadenceGroup) == type);
    try std.testing.expect(@TypeOf(workflows.OpenTimestampsStoredVerificationTargetRefreshCadenceStorage) == type);
    try std.testing.expect(@TypeOf(workflows.OpenTimestampsStoredVerificationTargetRefreshCadenceRequest) == type);
    try std.testing.expect(@TypeOf(workflows.OpenTimestampsStoredVerificationTargetRefreshCadencePlan) == type);
    try std.testing.expect(@TypeOf(workflows.OpenTimestampsStoredVerificationTargetRefreshCadenceStep) == type);
    try std.testing.expect(@TypeOf(workflows.OpenTimestampsStoredVerificationTargetRefreshBatchStorage) == type);
