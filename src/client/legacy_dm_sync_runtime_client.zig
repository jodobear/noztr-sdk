...
pub const LegacyDmSyncRuntimeClient = struct {
    ...
    fn selectAuthTarget(
        ...
        const live_descriptor = self.replay_job.replay_turn.replay_turn.replay_exchange.replay.relay_pool.descriptor(
...
fn fillAuthEventStorage(
    storage: *LegacyDmSyncRuntimeAuthEventStorage,
    relay_url_text: []const u8,
    challenge: []const u8,
) void {
...
) LegacyDmSyncRuntimeClientError![]const u8 {
