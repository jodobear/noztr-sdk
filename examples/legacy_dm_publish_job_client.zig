...
test "recipe: legacy dm publish job client keeps auth and publish explicit" {
    ...
    var storage = noztr_sdk.client.dm.legacy.publish_job.Storage{};
    var client = noztr_sdk.client.dm.legacy.publish_job.Client.init(.{
    ...
    var auth_storage = noztr_sdk.client.dm.legacy.publish_job.AuthStorage{};
