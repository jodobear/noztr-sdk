...
test "recipe: signer connect job stays explicit across auth and connect" {
    ...
    var storage = noztr_sdk.client.signer.connect_job.Storage{};
    var client = try noztr_sdk.client.signer.connect_job.Client.initFromBunkerUriText(
        .{},
        &storage,
        bunker_uri,
        arena.allocator(),
    ...
    var auth_storage = noztr_sdk.client.signer.connect_job.AuthEventStorage{};
