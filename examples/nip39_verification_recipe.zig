...
test "recipe: identity verifier verifies, remembers, groups watched-target discovery, inspects target policy, refresh cadence, refresh batch, turn policy, and turn buckets, and replays one profile event" {
    ...
    var watched_runtime_matches: [2]noztr_sdk.workflows.IdentityProfileMatch = undefined;
    var watched_runtime_entries: [3]noztr_sdk.workflows.IdentityStoredProfileTargetLatestFreshnessEntry = undefined;
    const watched_runtime = try noztr_sdk.workflows.IdentityVerifier.inspectStoredProfileRuntimeForTargets(
        profile_store.asStore(),
        .{
            .targets = watched_targets[0..],
            .now_unix_seconds = 31,
    ...
    try std.testing.expectEqual(
        noztr_sdk.workflows.IdentityStoredProfileTargetRuntimeAction.verify_now,
    ...
    var watched_cadence_matches: [2]noztr_sdk.workflows.IdentityProfileMatch = undefined;
    var watched_cadence_latest_entries: [3]noztr_sdk.workflows.IdentityStoredProfileTargetLatestFreshnessEntry = undefined;
    var watched_cadence_entries: [3]noztr_sdk.workflows.IdentityStoredProfileTargetRefreshCadenceEntry = undefined;
    var watched_cadence_groups: [5]noztr_sdk.workflows.IdentityStoredProfileTargetRefreshCadenceGroup = undefined;
    const watched_cadence = try noztr_sdk.workflows.IdentityVerifier.inspectStoredProfileRefreshCadenceForTargets(
        profile_store.asStore(),
        .{
            .targets = watched_targets[0..],
            .now_unix_seconds = 31,
            ...
            .fallback_policy = .allow_stale_latest,
            .storage = noztr_sdk.workflows.IdentityStoredProfileTargetRefreshCadenceStorage.init(
    ...
    var watched_batch_matches: [2]noztr_sdk.workflows.IdentityProfileMatch = undefined;
    var watched_batch_latest_entries: [3]noztr_sdk.workflows.IdentityStoredProfileTargetLatestFreshnessEntry = undefined;
    var watched_batch_cadence_entries: [3]noztr_sdk.workflows.IdentityStoredProfileTargetRefreshCadenceEntry = undefined;
    var watched_batch_cadence_groups: [5]noztr_sdk.workflows.IdentityStoredProfileTargetRefreshCadenceGroup = undefined;
    const watched_refresh_batch =
        try noztr_sdk.workflows.IdentityVerifier.inspectStoredProfileRefreshBatchForTargets(
            profile_store.asStore(),
            .{
                .targets = watched_targets[0..],
                .now_unix_seconds = 31,
                ...
                .max_selected = 2,
                .fallback_policy = .allow_stale_latest,
                .storage = noztr_sdk.workflows.IdentityStoredProfileTargetRefreshBatchStorage.init(
